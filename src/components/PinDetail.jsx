...
export default function PinDetail({ pin, session, categories, onClose, onDeleted }) {
  ...
  return (
    <div className="absolute bottom-4 left-4 right-4 md:left-auto md:right-4 md:w-96 bg-white rounded-xl shadow-xl p-6 z-[1000] max-h-[70vh] overflow-y-auto">
      ...
      {pin.description && (
        <p className="text-sm text-slate-700 mb-4 bg-slate-50 p-3 rounded-lg">
          {pin.description}
        </p>
      )}
